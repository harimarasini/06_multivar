...
k-means is useful when clusters are circular, but can fail badly when clusters have odd shapes (squares, circle within circle, i.e., one cluster is subset of another =) or outliers.  
...
If some variables have very high magnitude and is important and you want to give more weight, may be do not normalize but usually we normalize.
